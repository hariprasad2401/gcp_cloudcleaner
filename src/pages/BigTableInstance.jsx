...
import "../Components/SubNav/SubNavBarBigtable";
import SubNavBarBigtable from "../Components/SubNav/SubNavBarBigtable";
...
export default BigTableInstance;
export { f4 };
export { f5 };
