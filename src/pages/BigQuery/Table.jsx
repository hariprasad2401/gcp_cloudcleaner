...
import "../../Components/SubNav/SubNavBarTable";
import SubNavBarTable from "../../Components/SubNav/SubNavBarTable";
      ...
      const resData = await fetch(
        ...
        .then((res) => {
          ...
          for (let j = 0; j < test.length; j++) {
            ...
            if (map.asset_type === "bigquery/Table") {
              a.push(map);
