...
import "../Components/SubNav/SubNavBarArtifact";
import SubNavBarArtifact from "../Components/SubNav/SubNavBarArtifact";
      ...
      const resData = await fetch(
        ...
        .then((res) => {
          ...
          for (let j = 0; j < test.length; j++) {
            ...
            if (map.asset_type === "artifactregistry/DockerImage") {
              a.push(map);
            }
          }
          return a;
